...
- [lista-vaults-mcp](https://github.com/kukapay/lista-vaults-mcp) - Empowering AI agents to track and act across Lista DAO lending vaults.
- [euler-vaults-mcp](https://github.com/kukapay/euler-vaults-mcp) - Instant access to Euler Finance lending vaults.
...
- [dexscreener-trending-mcp](https://github.com/kukapay/dexscreener-trending-mcp) - Provides real-time trending tokens from DexScreener.
...
- [okx-announcements-mcp](https://github.com/kukapay/okx-announcements-mcp) - Latest announcements from OKX.
- [mexc-announcements-mcp](https://github.com/kukapay/mexc-announcements-mcp) - Latest announcements from MEXC.
